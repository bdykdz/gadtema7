...
class _$AppUser$ implements AppUser$ {
  const _$AppUser$({required this.id, required this.userName, required this.email, this.profileImages});
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, id, userName, email, profileImages);
